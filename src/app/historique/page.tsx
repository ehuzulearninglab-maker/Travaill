  ...
  return (
    <div className="space-y-5">
      <section className="rounded-md border border-stone-200 bg-white p-5 shadow-doux">
        ...
        <p className="mt-2 text-stone-600">Consultez les anciennes versions enregistrées automatiquement.</p>
      </section>
      ...
      <section className="space-y-3">
        {entries.map((entry) => (
          <Link
            ...
            className="flex flex-col gap-3 rounded-md border border-stone-200 bg-white p-4 shadow-doux transition hover:border-sauge md:flex-row md:items-center md:justify-between"
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-stone-600">Version {entry.version}</p>
              </div>
            </div>
